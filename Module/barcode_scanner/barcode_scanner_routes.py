...
api = APILibrary()
'''api.update_in_inventory('4533437', 'Weight', '20')

#api.add_to_inventory('777777', 'Ketchup', '250', 'g', '2021-05-01')

print(api.get_from_inventory('4533437'))
print(api.get_from_inventory('555555'))
print(api.get_from_inventory('777777'))'''
